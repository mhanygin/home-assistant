...
DEFARO_CONTROLLER_VER02 = 0x0041
DEFARO_DIMMER_VER02 = 0x0031
...
SOMFY_ZRTSI = 0x5a52
VIZIA_DIMMER = 0x1001
DEFARO_CONTROLLER = 0x0004
DEFARO_DIMMER = 0x0060
...
VIZIA_FAN_CONTROLLER_VRF01_MULTILEVEL = (
    ...
    const.COMMAND_CLASS_SWITCH_MULTILEVEL)
DEFARO_CONTROLLER_VER02_MULTILEVEL = (
    DEFARO, DEFARO_DIMMER, DEFARO_DIMMER_VER02,
    const.COMMAND_CLASS_SWITCH_MULTILEVEL
)
...
DEVICE_COMPONENT_MAPPING_MTI = {
    ...
    DEFARO_CONTROLLER_VER02_MULTILEVEL: 'dimmer',
}
